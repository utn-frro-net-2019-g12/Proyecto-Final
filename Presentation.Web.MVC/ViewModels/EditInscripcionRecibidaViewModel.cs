...
namespace Presentation.Web.MVC.ViewModels {
    public class EditInscripcionRecibidaViewModel {
        ...
        public EditInscripcionRecibidaViewModel(IEnumerable<MvcUsuarioModel> alumnos, IEnumerable<MvcHorarioConsultaFechadoModel> horariosConsultaFechados, MvcInscripcionModel inscripcion) {
